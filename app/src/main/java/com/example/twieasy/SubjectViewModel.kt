...
class SubjectViewModel: ViewModel() {
    ...
    @Volatile var klisSubjectNumber = mutableListOf<String>(
        ...
        "GA40103", //体験型システム開発A
        "GA40203", //体験型システム開発B
        "GA40303", //ビジネスシステムデザインA
        "GA40403", //ビジネスシステムデザインB
        "GE40201", //学習指導と学校図書館
        ...
        "GE70801", //データ表現と処理
        "GE70901", //データベース技術
        "GE71001", //情報デザインとインタフェース
        "GE71011", //情報デザインとインタフェース
        "GE73001", //情報デザインとインタフェースB
        "GE71101", //ヒューマンインタフェース
        "GE72501", //メディアアート
        "GE72601", //Human-computer Interaction
        "GE72801", //知識資源の分類と索引
        "GE71501", //クラウドコンピューティング
        "GE71701", //テキスト処理
